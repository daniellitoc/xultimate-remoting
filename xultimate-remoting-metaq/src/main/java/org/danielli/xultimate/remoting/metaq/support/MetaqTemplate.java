...
import org.danielli.xultimate.remoting.metaq.MetaqClientException;
...
public class MetaqTemplate implements DisposableBean {
    ...
    private MessageBodyConverter<Object> messageBodyConverter;
     ...
     * @return
     */
    public MessageBodyConverter<Object> getMessageBodyConverter() {
     ...
     * @since 1.4.5
     */
    public void setMessageBodyConverter(MessageBodyConverter<Object> messageBodyConverter) {
     ...
     * @since 1.4.5
     */
    public SendResult send(MessageBuilder builder) throws MetaqClientException {
        Message msg = builder.build(this.messageBodyConverter);
        final String topic = msg.getTopic();
        MessageProducer producer = this.getOrCreateProducer(topic);
        try {
